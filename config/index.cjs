  ...
  USERS: [
    {
      ...
      id: 'oHVfm6MEM_vF9SALEavsqyjO3ww0',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'mYTb68widGI6hyNQu2NK0DdMh0BBu78Rm8wD86SgVV4',
      // 所在省份
      province: '北京',
      // 所在城市
      city: '北京',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '晴宝', year: '1998', date: '02-16',
        },
        {
          type: '节日', name: '纪念日', year: '2020', date: '09-05',
        },
...
//         }
  ...
  CALLBACK_TEMPLATE_ID: 'GQh6KyeeLK_8EGBKR0Uv8DlCyQHuHuOVGH2sXnkR9wk',
  ...
  CALLBACK_USERS: [
    {
      ...
      id: 'oHVfm6KN8HfCSVY8HXkfOAffTNOM',
    }
    // 你可以不断按格式往下增加
    // ...
  ],
